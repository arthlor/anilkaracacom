...
techStack:
  ["Python", "Data Cleaning", "Custom React Charts", "Municipal Open Data"]
metrics:
  - label: "Kayıt sayısı"
    value: "17K+"
...
_Grafikleri daha iyi incelemek için mobil cihazlarınızı yatay konumda kullanmanızı öneririm._

...
import { formatCompactNumber, formatNumber } from "@/components/case-study/chartTheme";
      ...
      footer={
        <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
          <div className="viz-note">
            Aynı ayı iki farklı katmanda izlediğinizde, artışın yalnızca kapasiteyle
            değil hangi kullanıcı kitlesiyle geldiği de görünür oluyor. Bu, sistemin
            kim tarafından ve hangi araçlarla taşındığını birlikte okumayı sağlıyor.
          </div>
        ...
        <div className="grid gap-5 2xl:grid-cols-[minmax(0,1.3fr)_minmax(260px,0.7fr)]">
          ...
          <div className="rounded-[24px] border border-white/[0.07] bg-white/[0.015] p-4">
            ...
            <p className="viz-note mt-1">
              {monthLabel} döneminde sistemin ana gövdesi yine tam yolcu ve öğrenci
              kartlarında toplanıyor.
            </p>
            <div className="mt-4">
              <CurrentMonthMix
                groups={demographics.groups}

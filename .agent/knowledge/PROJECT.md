...
4. **Apps** - Mobile app showcases (e.g., Yeşer app)
5. **Case Studies** - Landing page storytelling projects
...
- Can embed React/Vue components for interactivity
...
- Current Site: https://anilkaraca.com
